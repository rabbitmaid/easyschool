<x-auth page-title="{{ $pageTitle }}" site-title="{{ $siteTitle }}">
    ...
    <div class="container mx-auto flex flex-col justify-center items-center min-h-screen px-5 py-5 md:px-0">
        ...
        <form action="{{ route('student.create') }}" class="bg-white p-5 rounded-md w-full md:w-[500px]" method="POST">
            @csrf
            ...
            <div class="md:flex justify-between gap-2">
                ...
                <div class="form-group mb-4 w-full">
                    ...
                    <select class="w-full p-2 mt-3 rounded-md bg-white border border-[#3b7ddd]" name="class" id="">
            ...
            {{-- <a href="{{ route('student.login') }}"
                class="bg-pink-600 hover:bg-pink-700 transition-all block text-center w-full p-2 rounded-md text-white mt-4">Click
                Here to Login</a> --}}

            <x-secondary-button :href="route('student.login')" buttonText="Click Here to Login" />
