            ...
            <div class="w-100">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <form action="{{ route('student.profile_image_update') }}" method="POST"
                            ...
                            <img src="https://ui-avatars.com/api/?name={{ Auth::user()->username }}&color=7F9CF5&background=EBF4FF&format=svg"
                                alt="Profile"
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center badge bg-primary rounded-pill p-2 w-100">
                            <p class="mb-0 text-uppercase">Current class: {{ Auth::user()->class->name }}</p>
                        </div>
                    </div>
            ...
            <div class="w-100">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('student.profile_update') }}" method="POST">
                            @csrf
                            @method('put')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="date_of_birth" id="date_of_birth"
                                    value="{{ Auth::user()->date_of_birth }}" class="form-control w-100" />
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="phone_number" name="phone_number" id="phone_number"
                                    value="{{ Auth::user()->phone_number }}" class="form-control w-100" />
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('student.password_update') }}" method="POST">
                            @csrf
                            @method('patch')

                            <div class="form-group mb-3">
                                <label for="new_password">Old Password</label>
                                <input type="password" name="old_password" id="new_password"
                                    class="form-control w-100" />
