                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <a href="{{ route('admin.liveclass.edit', $live_class->id) }}"
                                            class="btn btn-primary text-white" title="view live class">
                                        ...
                                        @if($live_class->status->id == 2)
                                        <a href="{{ route('admin.liveclass.activate', $live_class->id) }}" class="btn btn-success text-white" title="activate">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-toggle-left align-middle">
                                                <rect x="1" y="5" width="22" height="14" rx="7" ry="7"></rect>
                                                <circle cx="8" cy="12" r="3"></circle>
                                            </svg>
                                        </a>
                                        @elseif($live_class->status->id == 1)
                                        <a href="{{ route('admin.liveclass.deactivate', $live_class->id) }}" class="btn btn-warning text-white" title="deactivate">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-toggle-right align-middle">
                                                <rect x="1" y="5" width="22" height="14" rx="7" ry="7"></rect>
                                        ...
                                        <button type="button" class="btn btn-danger deleteButton" title="delete" data-toggle="modal" data-target="#deleteModal" resource-id="{{ $live_class->id }}" resource-name="liveclass">
                                        ...
                                        <x-modal-delete resource="live class" />
