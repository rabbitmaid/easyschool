            ...
            <div class="w-100">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="mb-4">Method Information</h3>

                        <form action="{{ route('admin.live_class_method.update', $method->id) }}" method="POST">
                            @csrf
                            @method('patch')

                            <div class="form-group mb-3">
                                <label for="name">Name</label>
                                <input type="text" name="name" id="name" value="{{ $method->name }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="description" id="descripion" class="form-control" style="resize: none">{{ $method->description }}</textarea>
